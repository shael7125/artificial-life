...
if __name__ == "__main__":
    ...
    # INITIAL POPULATION (auto-generated)
    robots = load_robots(num_robots=config["simulator"]["n_sims"])
    ...
    print(f"Best fitness: {fitness[best_idx]:.6f}")

    # Extract control params (simulator already trained)
    ...
    best_robot["fitness"] = fitness[best_idx]

    # Save separately
    np.save("best_robot_2.npy", best_robot)

    print("Best robot saved to best_robot_2.npy")
